...
*/
    ...
    //Spark k8s configurations
    public static final String SPARK_K8S_CONTAINER_IMAGE = "spark.kubernetes.container.image";
    ...
    // Spark-Gradle kubernetes task names
    static final String BUILD_DOCKER_IMAGE = "buildDockerImage";
    static final String COPY_DEPS_TO_DOCKER_BASE_DIR = "copyDepsToDockerBaseDir";
    ...
    // Spark-Gradle kubernetes task descriptions
    static final String BUILD_DOCKER_IMAGE_DESC = "Builds Docker image packing the jar containing the spark scala code and " +
            " and its dependencies";
    static final String COPY_DEPS_TO_DOCKER_BASE_DIR_DESC = "Copies built jar and its dependencies to Docker base directory";
